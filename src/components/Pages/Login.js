  ...
  return (
    <div className="dark:bg-gray-900 sm:p-20 sm:px-80">
      <div className="bg-gray-800 p-12 rounded-2xl flex flex-col items-center">
        ...
        <a className="bg-indigo-600 p-4 text-white rounded-2xl font-semibold" href="https://discord.com/oauth2/authorize?client_id=814494780251045928&response_type=code&redirect_uri=https%3A%2F%2Fpodash.vercel.app%2Foauth%2Fcallback&scope=identify+guilds+guilds.join">Login with Discord</a>
      </div>
    </div>
  );
};
